...
gaitParameters.stepLength.right = abs(data_openpose.scaling.factor*(data_openpose.filt_data(events_openpose.rhs_frames,1,1) - data_openpose.filt_data(events_openpose.rhs_frames,2,1)))';
gaitParameters.stepLength.left = abs(data_openpose.scaling.factor*(data_openpose.filt_data(events_openpose.lhs_frames,2,1) - data_openpose.filt_data(events_openpose.lhs_frames,1,1)))';
