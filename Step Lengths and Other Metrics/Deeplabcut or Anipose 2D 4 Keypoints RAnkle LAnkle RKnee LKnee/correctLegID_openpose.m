...
p = plot(squeeze(corrected_data(:,[1 2],1)),'.-'); zoom on; grid on
...
temp = corrected_data(frame,[1 3],:);
corrected_data(frame,[1 3],:) = corrected_data(frame,[2 4],:);
corrected_data(frame,[2 4],:) = temp;
subplot(3,3,[1 2 4 5 7 8]); delete(p)
p=plot(squeeze(corrected_data(:,[1 6],1)),'.-'); grid on; 
legend('right','left','location','northwest'); xlabel('frames'),ylabel('hor. position (pixel)');title(name)
set(gca,'xtick',frames)
...
frame = getCursorInfo(cursor_obj);
frame = frame.Position(1);
corrected_data(frame,[2 4],:) = raw_data(frame,[2 4],:);
subplot(3,3,[1 2 4 5 7 8]),delete(p)
p=plot(squeeze(corrected_data(:,[1 6],1)),'.-'); grid on
legend('right','left','location','northwest'); xlabel('frames'),ylabel('hor. position (pixel)');title(name)
set(gca,'xtick',frames)
...
frame = getCursorInfo(cursor_obj);
frame = frame.Position(1);
corrected_data(frame,[1 3],:) = raw_data(frame,[1 3],:);
subplot(3,3,[1 2 4 5 7 8]),delete(p)
p=plot(squeeze(corrected_data(:,[1 6],1)),'.-'); grid on
legend('right','left','location','northwest'); xlabel('frames'),ylabel('hor. position (pixel)');title(name)
set(gca,'xtick',frames)
...
corrected_data(:,[1 2 3 4],:) = raw_data(:,[1 2 3 4],:);
subplot(3,3,[1 2 4 5 7 8]),delete(p)
p=plot(squeeze(corrected_data(:,[1 6],1)),'.-'); grid on
legend('right','left','location','northwest'); xlabel('frames'),ylabel('hor. position (pixel)');title(name)
set(gca,'xtick',frames)
