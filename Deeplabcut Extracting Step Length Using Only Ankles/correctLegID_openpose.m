...
temp = corrected_data(frame,[1],:);
corrected_data(frame,[1],:) = corrected_data(frame,[2],:);
corrected_data(frame,[2],:) = temp;
...
frame = getCursorInfo(cursor_obj);
frame = frame.Position(1);
corrected_data(frame,[1],:) = raw_data(frame,[1],:);
subplot(3,3,[1 2 4 5 7 8]),delete(p)
p=plot(squeeze(corrected_data(:,[1 6],1)),'.-'); grid on
legend('right','left','location','northwest'); xlabel('frames'),ylabel('hor. position (pixel)');title(name)
set(gca,'xtick',frames)
...
frame = getCursorInfo(cursor_obj);
frame = frame.Position(1);
corrected_data(frame,[2],:) = raw_data(frame,[2],:);
subplot(3,3,[1 2 4 5 7 8]),delete(p)
p=plot(squeeze(corrected_data(:,[1 6],1)),'.-'); grid on
legend('right','left','location','northwest'); xlabel('frames'),ylabel('hor. position (pixel)');title(name)
set(gca,'xtick',frames)
...
corrected_data(:,[1 2],:) = raw_data(:,[1 2],:);
subplot(3,3,[1 2 4 5 7 8]),delete(p)
p=plot(squeeze(corrected_data(:,[1 6],1)),'.-'); grid on
legend('right','left','location','northwest'); xlabel('frames'),ylabel('hor. position (pixel)');title(name)
set(gca,'xtick',frames)
