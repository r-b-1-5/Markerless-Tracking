function calculate_gaitParameters_jointAngles(output_name)
...
cd = pwd;
load(fullfile(cd,file),'data_openpose','events_openpose')
...
% % % gaitParameters.stepLength.right = abs(data_openpose.scaling.factor*(data_openpose.filt_data(events_openpose.rhs_frames,2,1) - data_openpose.filt_data(events_openpose.rhs_frames,1,1)))';
% % % gaitParameters.stepLength.left = abs(data_openpose.scaling.factor*(data_openpose.filt_data(events_openpose.lhs_frames,1,1) - data_openpose.filt_data(events_openpose.lhs_frames,2,1)))';
gaitParameters.stepLength.right = abs((data_openpose.filt_data(events_openpose.rhs_frames,2,1) - data_openpose.filt_data(events_openpose.rhs_frames,1,1)))';
gaitParameters.stepLength.left = abs((data_openpose.filt_data(events_openpose.lhs_frames,1,1) - data_openpose.filt_data(events_openpose.lhs_frames,2,1)))';
...
% % jointAngles.sag_2D.LHip = atan2d(data_openpose.filt_data(:,14,2)-data_openpose.filt_data(:,13,2),data_openpose.filt_data(:,14,1)-data_openpose.filt_data(:,13,1)) + 90;
% % jointAngles.sag_2D.RHip = atan2d(data_openpose.filt_data(:,11,2)-data_openpose.filt_data(:,10,2),data_openpose.filt_data(:,11,1)-data_openpose.filt_data(:,10,1)) + 90;
%% calculate knee angles
% % jointAngles.sag_2D.LKnee = atan2d(data_openpose.filt_data(:,13,2)-data_openpose.filt_data(:,14,2),data_openpose.filt_data(:,13,1)-data_openpose.filt_data(:,14,1)) - atan2d(data_openpose.filt_data(:,15,2)-data_openpose.filt_data(:,14,2),data_openpose.filt_data(:,15,1)-data_openpose.filt_data(:,14,1)) - 180;
% % jointAngles.sag_2D.RKnee = atan2d(data_openpose.filt_data(:,10,2)-data_openpose.filt_data(:,11,2),data_openpose.filt_data(:,10,1)-data_openpose.filt_data(:,11,1)) - atan2d(data_openpose.filt_data(:,12,2)-data_openpose.filt_data(:,11,2),data_openpose.filt_data(:,12,1)-data_openpose.filt_data(:,11,1)) - 180;
%% calculate ankle angles
% % jointAngles.sag_2D.LAnkle = - ( atan2d(data_openpose.filt_data(:,14,2)-data_openpose.filt_data(:,15,2),data_openpose.filt_data(:,14,1)-data_openpose.filt_data(:,15,1)) - atan2d(data_openpose.filt_data(:,20,2)-data_openpose.filt_data(:,15,2),data_openpose.filt_data(:,20,1)-data_openpose.filt_data(:,15,1)) - 90 );
% % jointAngles.sag_2D.RAnkle = - ( atan2d(data_openpose.filt_data(:,11,2)-data_openpose.filt_data(:,12,2),data_openpose.filt_data(:,11,1)-data_openpose.filt_data(:,12,1)) - atan2d(data_openpose.filt_data(:,23,2)-data_openpose.filt_data(:,12,2),data_openpose.filt_data(:,23,1)-data_openpose.filt_data(:,12,1)) - 90 );
jointAngles.sag_2D.time = data_openpose.time;
%% save
save(fullfile(cd,file),'gaitParameters','jointAngles','-append')
clear